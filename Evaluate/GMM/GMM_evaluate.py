...
def plot_metrics(metrics, n_clusters_range):
    ...
    plt.tight_layout()
    plt.savefig("C:/Users/lenovo/Desktop/ML Project/ML_Project_Group12/Evaluate/GMM/evaluation.png", bbox_inches='tight', dpi=300)
    plt.show()
...
plt.grid(True, alpha=0.3)
plt.legend()
plt.savefig("C:/Users/lenovo/Desktop/ML Project/ML_Project_Group12/Evaluate/GMM/score.png", bbox_inches='tight', dpi=300)
plt.show()
